...
-- 2. Tabla de Restaurantes (Cat�logo de sistemas externos)
-- Sirve para saber a qu� URL llamar cuando el usuario elige uno
...
CREATE TABLE clientes (
    ...
    clave VARCHAR(100) NOT NULL, -- En producci�n real ir�a hasheada
...
-- 4. Tabla de Reservas (La transacci�n principal)
...
-- Los 4 Restaurantes que pide la c�tedra
